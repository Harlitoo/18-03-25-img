...
img.classList.add("bg-white"); // esta linha adiciona a classe "bg-white" (cor escura do bootstrap) ao elemento img
    ...
    function handleMouseDown(event) {
        try {
            ...
            if (event.target.tagName.toLowerCase() == "img") {
                ...
                imgTemp.classList.add("bg-white");
            ...
            console.error("PUTS!!! Aconteceu alguma coisa que não deu certo finalizar as linhas de código para o evento onmousedown. Veja o erro: ", e);
        }
    }
